 ...
 */
public class Sufism extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_sufism, container, false);
        ...
        FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
                        .setQuery(firebaseDatabase.getReference().child("Sufisim"), Book.class)
                        .build();

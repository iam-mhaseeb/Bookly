 ...
 */
public class Pashto extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_pashto, container, false);
        ...
        FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
                        .setQuery(firebaseDatabase.getReference().child("Pashto"), Book.class)
                        .build();
